...
// Topic.hasMany(Vote.voteRelationship, { as: 'votes', targetKey: 'topicId' });
// Prerequisite.hasMany(Vote.voteRelationship, { as: 'votes', foreignKey: 'prerequisiteId', targetKey: 'prerequisiteId' });
